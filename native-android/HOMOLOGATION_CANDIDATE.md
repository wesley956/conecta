...
A versão comercial 2.9.7 foi aprovada e publicada. O candidato 2.9.8 corrige somente o engasgo observado durante o crossfade final e deve ser testado fisicamente antes de qualquer nova promoção.
...
- executa esse crossfade em uma única animação nativa da GPU, sem atualizar estado Compose a cada frame;

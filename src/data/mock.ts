...
export const channels: Channel[] = [
  ...
  { id: 'ch4', name: 'GloboNews', group: 'news', url: '', isFavorite: true },
  { id: 'ch5', name: 'Band News', group: 'news', url: '', isFavorite: false },
  { id: 'ch6', name: 'Record News', group: 'news', url: '', isFavorite: false },
  { id: 'ch7', name: 'CNN Brasil', group: 'news', url: '', isFavorite: true },
  { id: 'ch8', name: 'Telecine Premium', group: 'movies', url: '', isFavorite: false },
  { id: 'ch9', name: 'Telecine Action', group: 'movies', url: '', isFavorite: false },
  { id: 'ch10', name: 'HBO', group: 'movies', url: '', isFavorite: true },
  { id: 'ch11', name: 'HBO Plus', group: 'movies', url: '', isFavorite: false },
  { id: 'ch12', name: 'FX', group: 'series', url: '', isFavorite: false },
  { id: 'ch13', name: 'AXN', group: 'series', url: '', isFavorite: false },
  { id: 'ch14', name: 'Cartoon Network', group: 'kids', url: '', isFavorite: false },
  { id: 'ch15', name: 'Disney Channel', group: 'kids', url: '', isFavorite: false },
  { id: 'ch16', name: 'Nickelodeon', group: 'kids', url: '', isFavorite: false },
  { id: 'ch17', name: 'SporTV', group: 'sports', url: '', isFavorite: true },
  { id: 'ch18', name: 'ESPN', group: 'sports', url: '', isFavorite: false },
  { id: 'ch19', name: 'Fox Sports', group: 'sports', url: '', isFavorite: false },
  { id: 'ch20', name: 'Band Sports', group: 'sports', url: '', isFavorite: false },
  { id: 'ch21', name: 'Discovery Channel', group: 'docs', url: '', isFavorite: false },
  { id: 'ch22', name: 'Nat Geo', group: 'docs', url: '', isFavorite: false },
  { id: 'ch23', name: 'History Channel', group: 'docs', url: '', isFavorite: false },
  { id: 'ch24', name: 'Rede Vida', group: 'religious', url: '', isFavorite: false },
  { id: 'ch25', name: 'Canção Nova', group: 'religious', url: '', isFavorite: false },
  { id: 'ch26', name: 'MTV', group: 'music', url: '', isFavorite: false },
  { id: 'ch27', name: 'VH1', group: 'music', url: '', isFavorite: false },
  { id: 'ch28', name: 'Music Box', group: 'music', url: '', isFavorite: false },
  { id: 'ch29', name: 'Multishow', group: 'variety', url: '', isFavorite: false },
  { id: 'ch30', name: 'GNT', group: 'variety', url: '', isFavorite: false },
  { id: 'ch31', name: 'Viva', group: 'variety', url: '', isFavorite: false },
  { id: 'ch32', name: 'SBT HD', group: 'open', url: '', isFavorite: false },
  { id: 'ch33', name: 'Record TV', group: 'open', url: '', isFavorite: false },
  { id: 'ch34', name: 'Rede Globo', group: 'open', url: '', isFavorite: false },
  { id: 'ch35', name: 'TNT', group: 'movies', url: '', isFavorite: false },
  { id: 'ch36', name: 'Cinemax', group: 'movies', url: '', isFavorite: false },
  { id: 'ch37', name: 'Premiere', group: 'sports', url: '', isFavorite: false },
  { id: 'ch38', name: 'Baby TV', group: 'kids', url: '', isFavorite: false },
  { id: 'ch39', name: 'Discovery Kids', group: 'kids', url: '', isFavorite: false },
  { id: 'ch40', name: 'Rá-Tim-Bum', group: 'kids', url: '', isFavorite: false },
  { id: 'ch41', name: 'BIS', group: 'music', url: '', isFavorite: false },
  { id: 'ch42', name: 'Megapix', group: 'movies', url: '', isFavorite: false },
  { id: 'ch43', name: 'Universal TV', group: 'series', url: '', isFavorite: false },
  { id: 'ch44', name: 'Warner Channel', group: 'series', url: '', isFavorite: false },
  { id: 'ch45', name: 'A&E', group: 'series', url: '', isFavorite: false },
...
export const watchHistory: WatchHistory[] = [
  { id: 'wh1', contentType: 'channel', contentId: 'ch17', name: 'SporTV', watchedAt: '2025-01-15 22:00', progress: undefined },
  ...
  { id: 'wh5', contentType: 'channel', contentId: 'ch10', name: 'HBO', watchedAt: '2025-01-14 19:00', progress: undefined },
